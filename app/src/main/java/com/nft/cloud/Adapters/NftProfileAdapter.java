...
public class NftProfileAdapter extends RecyclerView.Adapter<NftProfileAdapter.NotificationViewHolder> {
    private List<AllNftModel> allNftModelList;
    Context context;

    public NftProfileAdapter(List<AllNftModel> allNftModelList, Context context) {
    ...
    public NotificationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_nft_profile, parent, false);
    ...
    public void onBindViewHolder(@NonNull NotificationViewHolder holder, final int position) {
        ...
        holder.likes.setText(context.getString(R.string.likes) + allNftModelList.get(position).getLikes_counter());
                ...
                if (allNftModelList.get(position) != null) {
                    ...
                    like.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Toast.makeText(context, context.getString(R.string.liked_success), Toast.LENGTH_SHORT).show();
